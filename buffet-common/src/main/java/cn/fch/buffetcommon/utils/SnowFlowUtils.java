...
public class SnowFlowUtils {
    ...
    private static class SnowFlowIoDH {
        public static final SnowFlowUtils utils = new SnowFlowUtils(1, 1, 0);
    }

    public static SnowFlowUtils getInstance() {
        return SnowFlowIoDH.utils;
    }

    private SnowFlowUtils(long workerId, long datacenterId, long sequence) {
    ...
    private final long twepoch = LocalDateTime.of(2023, 1, 1, 0, 0, 0, 0).toInstant(ZoneOffset.of("+8")).toEpochMilli() ;
    //5位的机器id
